...
cp ${REF_DIR}/refpanel_chr${chr}_${begin}.vcf.gz .
...
python3 XGMIX.py  ${study}_phased_chr${chr}_${begin}.vcf.gz  ${WORKING_DIR}/recombination_maps/HapMapcomb_genmap_chr${chr}_tab.txt  xgmix/${study}_${chr}_${begin}  ${chr}  FALSE  refpanel_chr${chr}_${begin}.vcf.gz  $ref_subjects
