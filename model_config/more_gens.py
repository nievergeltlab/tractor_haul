...
r_admixed = 10.0 # number of individuals as a function of founders_ratios.
generations = [0, 2, 4, 6, 8, 12, 16, 24, 32, 48, 64, 96, 128, 192, 256, 352, 448, 576, 704, 896, 1024] # generations to generate during simulation
